...
const ExpensesPage: React.FC = () => {
  return (
    // Apply the spend/tan gradient to align with the reference design
    <div className="p-4 space-y-6 gradient-spend-tan">
      ...
      <Card className="glass-card">
        ...
        <CardFooter className="justify-center">
          {/* Use button-primary for consistent CTA styling */}
          <Button
